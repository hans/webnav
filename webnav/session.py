...
class PartialRunSessionManager(SessionManager):

    def __init__(self, partial_fetches, partial_feeds, *args, **kwargs):
        self._partial_fetches = partial_fetches
        self._partial_feeds = partial_feeds
